---
name: graphify
description: "Use only when the user invokes /graphify or asks for broad architecture, dependency, relationship, path, or impact exploration. Do not use for routine story phases, known-file edits, focused testing, QA, Security, DoF, git, or release work."
---
