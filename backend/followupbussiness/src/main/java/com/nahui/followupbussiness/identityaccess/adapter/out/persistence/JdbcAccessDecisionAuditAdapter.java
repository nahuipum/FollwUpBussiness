...
public final class JdbcAccessDecisionAuditAdapter implements AccessDecisionAuditPort {
    ...
    public JdbcAccessDecisionAuditAdapter(JdbcTemplate jdbc) {
        this.jdbc = jdbc;
    }

    @Override
    public void record(UUID correlationId, UUID actorId, UUID tenantId, String type, UUID resourceId, boolean allowed) {
