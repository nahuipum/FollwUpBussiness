...
public final class AuditCustomerImportProcessing implements CustomerImportProcessingAudit {
    private final AuditEntryStore store; private final Clock clock;
    public AuditCustomerImportProcessing(AuditEntryStore store, Clock clock) { this.store = store; this.clock = clock; }
    @Override public void record(UUID tenantId, UUID actorId, UUID importId, UUID correlationId, String status) {
