...
public final class CustomerImportController {
 private final CreateCustomerImportUseCase create; private final GetCustomerImportUseCase get;
 public CustomerImportController(CreateCustomerImportUseCase create, GetCustomerImportUseCase get) { this.create=create; this.get=get; }
