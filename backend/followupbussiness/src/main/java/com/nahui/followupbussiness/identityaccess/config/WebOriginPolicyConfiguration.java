...
public class WebOriginPolicyConfiguration {
    @Bean
    WebOriginPolicy webOriginPolicy(AuthenticationProperties.Values properties) {
        return origin -> properties.getWebOrigin() != null && properties.getWebOrigin().equals(origin);
    }
}
