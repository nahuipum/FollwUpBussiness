...
- **Predecesoras obligatorias:** `BE-017` — Consultar historial de cliente
- **Historias consecuentes que habilita:** `BE-050` — Exportar reportes; `INT-020` — Histórico por cliente E2E
