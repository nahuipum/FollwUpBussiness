...
- **Predecesoras obligatorias:** `BE-036` — Finalizar visita; `BE-051` — Registrar acciones críticas
- **Historias consecuentes que habilita:** `FE-025` — Corregir visita; `INT-016` — Consulta administrativa de visitas
