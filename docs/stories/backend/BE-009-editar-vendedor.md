# BE-009 — Editar vendedor
    ...
    **Como** administrador  
    **Quiero** actualizar un vendedor  
    **Para** mantener datos

    ## Alcance

    Editar sin romper historial.
...
- **Predecesoras obligatorias:** `BE-008` — Crear vendedor; `BE-059` — Listar y consultar vendedores
