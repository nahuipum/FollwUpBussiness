...
- **Predecesoras obligatorias:** `BE-046` — Consultar histórico de ventas; `BE-048` — Reporte por vendedor; `BE-049` — Reporte por cliente; `BE-056` — Gestionar reintentos y DLQ
- **Historias consecuentes que habilita:** `FE-031` — Reportes y exportaciones; `INT-040` — Exportación de reportes E2E
