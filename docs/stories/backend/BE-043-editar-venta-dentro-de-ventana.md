# BE-043 — Editar venta dentro de ventana
    ...
    **Fase:** MVP condicionado; anulación auditada permanece como flujo base
...
- **Predecesoras obligatorias:** `BE-042` — Registrar venta; `BE-054` — Configurar geocerca y tracking
- **Historias consecuentes que habilita:** `INT-037` — Edición de venta E2E; `MOB-032` — Editar venta dentro de ventana
