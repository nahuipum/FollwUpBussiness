...
- **Predecesoras obligatorias:** `BE-051` — Registrar acciones críticas
- **Historias consecuentes que habilita:** `FE-032` — Consulta de auditoría; `INT-025` — Auditoría transversal
