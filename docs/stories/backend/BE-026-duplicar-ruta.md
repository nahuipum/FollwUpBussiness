# BE-026 — Duplicar ruta
    ...
    **Como** administrador  
    **Quiero** copiar ruta  
    **Para** reutilizar planificación

    ## Alcance

    Crear borrador para nueva fecha.

    ## Criterios de aceptación

    1. Original intacta.
2. Nueva fecha.
3. Advierte inactivos.
4. Estado borrador.
...
- **Historias consecuentes que habilita:** `FE-014` — Listado de rutas; `INT-007` — Creación manual E2E
