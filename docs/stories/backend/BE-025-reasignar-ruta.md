...
- **Predecesoras obligatorias:** `BE-024` — Publicar ruta; `BE-053` — Notificar ruta publicada o modificada
- **Historias consecuentes que habilita:** `FE-018` — Reasignar ruta; `INT-009` — Reasignación E2E
- **Validación vertical:** `INT-009` — Reasignación E2E
