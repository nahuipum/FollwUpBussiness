...
- **Predecesoras obligatorias:** `BE-035` — Iniciar visita
- **Historias consecuentes que habilita:** `BE-039` — Corregir visita; `BE-040` — Consultar visitas y pendientes; `BE-042` — Registrar venta; `INT-014` — Check-out E2E; `INT-015` — Visita offline sincronizada; `MOB-016` — Finalizar visita; `MOB-017` — Registrar motivo de no venta
- **Validación vertical:** `INT-014` — Check-out E2E; `INT-015` — Visita offline sincronizada
