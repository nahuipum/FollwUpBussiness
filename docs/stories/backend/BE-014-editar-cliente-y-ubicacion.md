...
- **Historias consecuentes que habilita:** `FE-009` — Formulario de cliente y mapa; `INT-005` — Cliente visible en mapa; `INT-031` — Retención y eliminación lógica E2E
- **Validación vertical:** `INT-005` — Cliente visible en mapa; `INT-031` — Retención y eliminación lógica E2E
