# BE-037 — Registrar visita fuera de ruta
    ...
    **Fase:** MVP condicionado por configuración de empresa
...
- **Predecesoras obligatorias:** `BE-035` — Iniciar visita; `BE-054` — Configurar geocerca y tracking
- **Historias consecuentes que habilita:** `INT-016` — Consulta administrativa de visitas; `MOB-018` — Registrar visita fuera de ruta
