...
- **Predecesoras obligatorias:** `BE-013` — Registrar cliente
- **Historias consecuentes que habilita:** `BE-019` — Procesar importación de clientes; `FE-012` — Carga de clientes; `INT-006` — Importación completa de clientes
