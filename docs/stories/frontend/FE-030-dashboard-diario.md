...
- **Predecesoras obligatorias:** `BE-047` — Calcular dashboard diario; `FE-003` — Gestión de sesión; `FE-034` — Manejo global de errores y permisos
- **Historias consecuentes que habilita:** `FE-031` — Reportes y exportaciones; `INT-022` — Dashboard diario E2E
