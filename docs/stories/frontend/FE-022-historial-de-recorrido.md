...
- **Predecesoras obligatorias:** `BE-032` — Consultar historial de recorrido; `EN-014` — Definir proveedor de mapas, geocodificación y navegación; `EN-016` — Definir privacidad, retención y rastreo; `FE-003` — Gestión de sesión; `FE-034` — Manejo global de errores y permisos
- **Historias consecuentes que habilita:** `INT-012` — Recorrido histórico E2E
- **Validación vertical:** `INT-012` — Recorrido histórico E2E
