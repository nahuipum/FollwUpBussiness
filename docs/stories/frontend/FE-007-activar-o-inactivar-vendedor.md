...
- **Predecesoras obligatorias:** `BE-010` — Activar o inactivar vendedor; `FE-005` — Listado de vendedores
- **Historias consecuentes que habilita:** `INT-004` — Alta de vendedor disponible en mobile
