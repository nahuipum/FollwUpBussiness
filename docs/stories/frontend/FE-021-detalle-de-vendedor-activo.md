...
- **Predecesoras obligatorias:** `BE-030` — Mantener última ubicación en Redis; `BE-040` — Consultar visitas y pendientes; `BE-045` — Consultar ventas del día; `FE-020` — Mapa en tiempo real
- **Historias consecuentes que habilita:** `INT-021` — Resultados por vendedor E2E
