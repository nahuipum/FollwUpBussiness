...
- **Predecesoras obligatorias:** `BE-045` — Consultar ventas del día; `FE-003` — Gestión de sesión; `FE-034` — Manejo global de errores y permisos
- **Historias consecuentes que habilita:** `FE-027` — Histórico de ventas; `FE-028` — Resultados por vendedor; `FE-029` — Anular venta; `INT-017` — Venta durante visita E2E; `INT-018` — Venta offline sincronizada; `INT-019` — Ventas del día E2E
- **Validación vertical:** `INT-017` — Venta durante visita E2E; `INT-018` — Venta offline sincronizada; `INT-019` — Ventas del día E2E
