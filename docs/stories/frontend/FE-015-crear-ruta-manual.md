...
- **Predecesoras obligatorias:** `BE-021` — Crear ruta manual; `BE-023` — Reordenar puntos de ruta; `BE-027` — Sugerir clientes por frecuencia; `BE-061` — Consultar rutas y ruta del día; `FE-014` — Listado de rutas
- **Historias consecuentes que habilita:** `FE-017` — Publicar ruta; `INT-007` — Creación manual E2E; `INT-008` — Generación automática E2E
