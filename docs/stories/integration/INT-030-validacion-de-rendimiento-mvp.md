...
- **Predecesoras obligatorias:** `INT-006` — Importación completa de clientes; `INT-011` — Ubicación en tiempo real E2E; `INT-019` — Ventas del día E2E; `INT-022` — Dashboard diario E2E
...
- **Debe estar listo antes de desarrollar:** Perfil de carga, SLOs y volumen objetivo del MVP.
