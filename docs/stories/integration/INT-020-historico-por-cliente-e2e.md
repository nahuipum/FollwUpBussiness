# INT-020 — Histórico por cliente E2E
    ...
    **Para** analizar compras

    ## Alcance

    Clientes + visitas + ventas + panel.
...
- **Predecesoras obligatorias:** `BE-017` — Consultar historial de cliente; `BE-046` — Consultar histórico de ventas; `BE-049` — Reporte por cliente; `FE-011` — Historial de cliente; `FE-027` — Histórico de ventas
