...
- **Predecesoras obligatorias:** `BE-035` — Iniciar visita; `BE-036` — Finalizar visita; `EN-015` — Definir persistencia local y sincronización móvil; `MOB-014` — Iniciar visita offline; `MOB-015` — Recuperar visita activa tras reinicio; `MOB-016` — Finalizar visita; `MOB-028` — Recuperar cola tras cierre forzado
