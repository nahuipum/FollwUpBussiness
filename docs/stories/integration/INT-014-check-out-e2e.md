...
- **Predecesoras obligatorias:** `BE-036` — Finalizar visita; `FE-023` — Listado de visitas; `FE-024` — Detalle de visita; `MOB-016` — Finalizar visita; `MOB-017` — Registrar motivo de no venta
