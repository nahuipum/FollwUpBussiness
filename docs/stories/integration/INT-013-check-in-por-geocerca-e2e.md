# INT-013 — Check-in por geocerca E2E
    ...
    **Como** vendedor  
    **Quiero** marcar visita  
    **Para** validar presencia

    ## Alcance

    Flutter + API + PostGIS + panel.
...
- **Predecesoras obligatorias:** `BE-034` — Validar proximidad; `BE-035` — Iniciar visita; `BE-054` — Configurar geocerca y tracking; `FE-033` — Configurar geocerca y tracking; `MOB-011` — Calcular proximidad local; `MOB-012` — Habilitar flag de visita; `MOB-013` — Iniciar visita online
