...
- **Predecesoras obligatorias:** `BE-003` — Autenticar usuario; `BE-004` — Renovar sesión; `BE-005` — Cerrar y revocar sesión; `BE-006` — Recuperar contraseña; `BE-007` — Gestionar roles y permisos; `FE-001` — Pantalla de inicio de sesión; `FE-002` — Recuperación de contraseña; `FE-003` — Gestión de sesión; `FE-034` — Manejo global de errores y permisos
