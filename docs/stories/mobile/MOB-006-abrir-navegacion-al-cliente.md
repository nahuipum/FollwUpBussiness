# MOB-006 — Abrir navegación al cliente
    ...
    **Como** vendedor  
    **Quiero** navegar al cliente  
    **Para** llegar al punto

    ## Alcance

    Abrir proveedor de mapas.

    ## Criterios de aceptación

    1. Usa coordenadas.
2. Maneja faltantes.
3. No marca automáticamente.
4. Permite retorno.
...
- **Predecesoras obligatorias:** `EN-014` — Definir proveedor de mapas, geocodificación y navegación; `MOB-005` — Ver clientes pendientes y visitados
- **Historias consecuentes que habilita:** `INT-007` — Creación manual E2E
