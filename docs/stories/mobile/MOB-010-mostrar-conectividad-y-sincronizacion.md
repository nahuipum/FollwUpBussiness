...
- **Predecesoras obligatorias:** `MOB-009` — Encolar ubicaciones sin conexión
- **Historias consecuentes que habilita:** `MOB-024` — Cerrar jornada; `MOB-025` — Resolver cierre con pendientes
