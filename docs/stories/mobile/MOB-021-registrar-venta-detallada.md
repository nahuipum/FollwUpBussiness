# MOB-021 — Registrar venta detallada
    ...
    **Fase:** MVP condicionado; MOB-020 es la venta mínima obligatoria
...
- **Predecesoras obligatorias:** `BE-041` — Gestionar productos; `BE-042` — Registrar venta; `MOB-016` — Finalizar visita; `MOB-019` — Consultar catálogo offline
