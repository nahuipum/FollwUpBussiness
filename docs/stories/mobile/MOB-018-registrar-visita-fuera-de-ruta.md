# MOB-018 — Registrar visita fuera de ruta
    ...
    **Quiero** visitar cliente no planificado  
...
- **Predecesoras obligatorias:** `BE-037` — Registrar visita fuera de ruta; `MOB-012` — Habilitar flag de visita
