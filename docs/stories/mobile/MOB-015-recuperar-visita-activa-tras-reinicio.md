...
- **Predecesoras obligatorias:** `MOB-014` — Iniciar visita offline; `MOB-027` — Proteger datos locales
- **Historias consecuentes que habilita:** `INT-015` — Visita offline sincronizada
