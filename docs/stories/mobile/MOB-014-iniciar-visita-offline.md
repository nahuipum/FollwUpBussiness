...
- **Predecesoras obligatorias:** `BE-035` — Iniciar visita; `EN-015` — Definir persistencia local y sincronización móvil; `MOB-012` — Habilitar flag de visita
- **Historias consecuentes que habilita:** `INT-015` — Visita offline sincronizada; `MOB-015` — Recuperar visita activa tras reinicio; `MOB-016` — Finalizar visita
- **Validación vertical:** `INT-015` — Visita offline sincronizada
