...
export function RouteDetailDialog({ target, route, sellerLabel, loading, error, onRetry, onClose }: { target: Route; route: Route | null; sellerLabel: string; loading: boolean; error: ApiError | null; onRetry: () => void; onClose: () => void }) {
