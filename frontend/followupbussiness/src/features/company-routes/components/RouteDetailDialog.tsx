...
export function RouteDetailDialog({ target, route, sellerLabel, loading, error, canGenerateProposal, onGenerateProposal, onRetry, onClose }: { target: Route; route: Route | null; sellerLabel: string; loading: boolean; error: ApiError | null; canGenerateProposal: boolean; onGenerateProposal: (route: Route) => void; onRetry: () => void; onClose: () => void }) {
